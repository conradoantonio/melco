    ...
    <div class="bg-dark m-b-30">
        <div class="container">
            <div class="row p-b-60 p-t-60">
                <div class="col-md-6 text-white p-b-30 general-info" data-url="{{url("ordenes")}}" data-refresh="table" data-el-loader="refreshable">
                    <div class="media">
...
<script type="text/javascript">
    ...
    function getPrintable(data, config) {
        ...
        var route = baseUrl.concat('/ordenes/get-printable/'+item.id);
