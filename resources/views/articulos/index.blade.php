        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 m-auto text-white p-t-40 p-b-90">
                    <h1>{{$title}}</h1>
                    <p class="opacity-75">
                        En este módulo podrá filtrar los artículos disponibles en la app móvil.
                    </p>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-controls">
                            ...
                            <a href="{{url('articulos/form')}}"><button class="btn btn-dark" type="button">Nuevo producto</button></a>
                            ...
                            <div class="col-md-9 text-right my-auto filter-section">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <div class="no-pad text-left">
                                        <select class="form-control select2" name="tipo_articulo_id">
