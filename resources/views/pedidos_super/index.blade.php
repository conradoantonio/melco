        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 m-auto text-white p-t-40 p-b-90">
                    <h1>Pedidos</h1>
                    <p class="opacity-75">
                        Aquí podrá visualizar los pedidos realizados desde la aplicación móvil.
                    </p>
                </div>
                <div class="col-md-4 m-auto text-white p-t-40 p-b-90 general-info" data-url="{{url("pedidos")}}" data-refresh="table" data-el-loader="refreshable">
                        ...
                        <div class="p-all-15">
                            <div class="row">
                                <div class="col-md-12 my-2 m-md-0">
                                    ...
                                    <h3 class="m-0 text-success">${{number_format(5200020)}} MXN</h3>
                                </div>
                                    ...
                                    <div class="no-pad">
                                        <select class="form-control" name="proveedor_id">
                                            ...
                                            @foreach($sucursales as $sucursal)
                                                <option value="{{$sucursal->id}}">{{$sucursal->fullname}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="no-pad">
    ...
    $('body').delegate('.change-order-status', 'click', function() {
        ...
        if ( status ) {
            ...
            $.each(status, function(key, value) {
                ...
                if ( value.id < 5 && ( value.id > row_status ) ) {
